...
class AdvancedLogger(logging.Logger):
    ...
    @contextmanager
    def suppressed(
        self, suppress: bool = True, universe: bool = False
    ...
    def suppressed_other(
        self, name: str, suppress: bool = True, below: Union[int, str] = logging.ERROR
    ) -> Generator[None, None, None]:
        """
